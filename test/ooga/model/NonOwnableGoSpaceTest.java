...
import ooga.model.boardSpaces.NonOwnableGoSpace;
...
public class NonOwnableGoSpaceTest extends DukeApplicationTest {
    ...
    public void testLandOnGo(){
       ...
       // sleep(3, TimeUnit.SECONDS);
        ...
        NonOwnableGoSpace space = new NonOwnableGoSpace("Go", new ClassicBank(players));
        space.landOnSpace(p,0);
        assertTrue(p.getPlayerBalance() == 200);
    }
