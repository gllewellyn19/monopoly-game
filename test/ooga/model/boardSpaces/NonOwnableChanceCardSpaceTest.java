...
class NonOwnableChanceCardSpaceTest extends DukeApplicationTest {
    ...
    void landOnSpace() {
      ...
      //  sleep(3, TimeUnit.SECONDS);
        ...
        NonOwnableCardSpace space = new NonOwnableChanceCardSpace("Chance Card Space", new ClassicBank(players), gamePlay.getCards());
